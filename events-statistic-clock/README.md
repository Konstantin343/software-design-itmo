...
### Цель: получить практический опыт применения паттерна SettableClock при реализации тестов.
...
Реализацию EventsStatistic необходимо покрыть тестами, используя паттерн SettableClock, рассмотренный на лекции.  
